...
<!-- color CSS -->
<link href="<?php echo base_url('asset/') ?>css/colors/megna.css" id="theme"  rel="stylesheet">
...
<section id="wrapper" class="error-page">
  <div class="error-box">
    <div class="error-body text-center">
      ...
      <p class="text-muted m-t-30 m-b-30 text-uppercase">Kamu tidak memiliki hak akses di Halaman ini.</p>
      <a href="<?= base_url('Beranda') ?>" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
    <footer class="footer text-center">2018 © Jasa Softdroid .</footer>
  </div>
</section>
<!-- jQuery -->
