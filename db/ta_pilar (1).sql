...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Apr 2020 pada 12.54
...
INSERT INTO `detail_pemesanan` (`ID_DOMBA`, `ID_PEMESANAN`, `JUMLAH`, `BERAT`, `SUBTOTAL`) VALUES
('D1B001', 'T1404200001', 1, 2, 25000),
('D2J001', 'T1404200001', 2, 2, 30000),
('D3B001', 'T1404200001', 1, 1, 34000);
...
INSERT INTO `pembayaran` (`ID_PEMBAYARAN`, `ID_PEGAWAI`, `ID_PEMESANAN`, `TGL_PEMBAYARAN`, `JENIS_BAYAR`, `TOTAL_PEMBAYARAN`, `BUKTI_TRANSFER`, `STATUS_PEMBAYARAN`) VALUES
('B14042000011', 'P0002', 'T1404200001', '2020-04-14 10:10:30', 'Transfer', '44500', 'B14042000011.jpg', 'Mencicil');
...
INSERT INTO `pemesanan` (`ID_PEMESANAN`, `ID_PELANGGAN`, `ID_KOTA`, `ID_PEGAWAI`, `NAMA_PENERIMA`, `TELP_PENERIMA`, `ALAMAT_PENERIMA`, `KODEPOS_PENERIMA`, `TGL_PESAN`, `SISTEM_BAYAR`, `ONGKOS_KIRIM`, `TOTAL_BERAT`, `TOTAL_HARGA`, `STATUS_TRANSAKSI`) VALUES
('T1404200001', 'C0001', '444', 'P0002', 'rizky dwi aditya', '08573000803', 'Jl. Simowau baru gg semanggi n', '61473', '2020-04-14 10:10:30', 'Cicilan', '30000', 5, '119000', 'Menunggu pengiriman');
